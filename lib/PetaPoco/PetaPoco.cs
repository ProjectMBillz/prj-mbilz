	...
	public class Database : IDisposable
	{
		...
		public void BuildPageQueries<T>(long skip, long take, string sql, ref object[] args, out string sqlCount, out string sqlPage) 
		{
			...
			if (_dbType == DBType.SqlServer )
			{
                ...
                //Comment by Osazee Igbinosun 18 May 2015
            //had to remove the select from the (SELECT NULL) because it was hiding the "FROM" keyword and throwing ORA-00923.
                //a query transformer might be needed for some strange queries.. because it slows down..
                // this happens only during paging .
                //but for standard Persistent Objects it works pretty fine and in decent speed.
